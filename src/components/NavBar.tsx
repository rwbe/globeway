    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          {/* Logo moderno */}
          <Link to="/" className="flex items-center space-x-3 group" onClick={handleGoBack}>
            <motion.div
          ...
          <div className="flex items-center space-x-2">
            ...
            <motion.button
              ...
              title="Alternar idioma / Change language / Cambiar idioma"
            >
              <img
            ...
            >
              <Github
                className={`w-4 h-4 ${isDarkMode ? 'text-neutral-300' : 'text-neutral-700'}`}
              />
            </motion.a>
            ...
            >
              <motion.div
                ...
                className={isDarkMode ? 'text-white' : 'text-neutral-700'}
              >
